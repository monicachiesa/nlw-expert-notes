...
export function NoteCard(props: NoteCardProps) {
    return (
        <Dialog.Root>
            <Dialog.Trigger className='rounded-md outline-none flex flex-col text-left focus-visible:ring-2 focus:ring-lime-400 bg-slate-800 p-5 gap-3 overflow-hidden relative hover:ring-2 hover:ring-slate-600 '>
            ...
            <Dialog.Portal>
                ...
                <Dialog.Content className='fixed overflow-hidden left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 max-w-[640px] w-full outline-none bg-slate-700 rounded-md flex flex-col h-[60vh]'>
                    ...
                    <button
                        type="button"
                        className='w-full bg-slate-800 py-4 text-center group text-sm font-medium text-slate-300 outline-none'>
